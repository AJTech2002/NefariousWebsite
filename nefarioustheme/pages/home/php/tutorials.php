<html id="TutorialHTML">
  ...
  <div class="Seperator"></div>
    ...
    <h2 id="FeaturedTutorials"> FEATURED TUTORIALS </h2>

    <div class="TutorialsContainer">

      <div id="TUTORIAL1">
        <div class="TutCont">
          <div class="TutImage" style="background-color: #51A7DD"></div>
      ...
      <div id="TUTORIAL2">
        <div class="TutCont" >
          <div class="TutImage" style="background-color: #8054A2"></div>
          <h3 class="TutorialName">THE COMPLETE MACHINE LEARNING COURSE</h3>
          <h4 class="TutorialAuthor">BY AJAY VENKAT</h4>
      ...
      <div id="TUTORIAL3">
        <div class="TutCont">
          <div class="TutImage" style="background-color: #EFAE3B"></div>
          <h3 class="TutorialName">THE COMPLETE MACHINE LEARNING COURSE</h3>
          <h4 class="TutorialAuthor">BY AJAY VENKAT</h4>
