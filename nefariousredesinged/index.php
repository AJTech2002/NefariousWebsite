...
<html>
  <body>
    ...
    <div class="FullBody">
        ...
        <div id="Left01" style="">
          <div class="Slideshow">
            <h3 style="margin-left: 20px; width: 400px; font-size: 30px;"> THE POST OF THIS TITLE </h3>
            <p> The description of this post, will be shown underneath this post, when
                the mouse will be hovered over this slide. This will be shown very
                stylisticly maybe use the tool tip function from the internet in order
                to show this using an increasing opacity. </p>
         </div>
          <div class="Seperator" style="margin: 20px; margin-bottom: 0px;"></div>
        </div>

        <div id="Left02" style="">
          <h2 style="margin-left: 40px;"> POPULAR TUTORIALS </h2>
          <div style="overflow: hidden" class="GreenCallToAction"><p>MORE TOPICS</p></div>
          <div id="TutorialTable">

            <div id="OA">
              <div class="TutorialHead"> UNITY </div>

              <div style="background-color: #D1D3D4; position: relative;" class="TutorialPost">
                  <div class="HoverContainer">
                    <span> </span>
                    <p> This is the description of the tutorial that </br>
                      you are about to click on today </br> I hope you really
                      learn something from this </p>
                    <div class="ProgressBarContainer">
                      <div class="ProgressBar" style="width: 75%">DIFFICULTY</div>
                    </div>
                  </div>
                  <div class="TitleBox">
                    <h2> TITLE OF THIS TUTORIAL </h2>
                  </div>
            ...
            <div id="OB">
              <div class="TutorialHead"> MACHINE LEARNING </div>
              <div style="background-color: #D1D3D4; position: relative;" class="TutorialPost">
                  <div class="HoverContainer">
                    <span> </span>
                    <p> This is the description of the tutorial that </br>
        ...
        <div id="Left04" style="">
          ...
          <div class="LatestPost">
            ...
            <h4>POST TITLE</h4>
            <p>This is a simple descriptio of wat this post was about, sometimes this will justify-contentbe a log so have a tag
              explaining what this is to make sure the audience understands... </p>
            <div class="Seperator" style="margin-left: 40px; margin-right: 40px;"></div>
          </div>
          <div class="LatestPost">
            <div class="PostThumbnail" style="width: 90px; height: 90px; background-color:#EAAB39;"></div>
            <h4>POST TITLE</h4>
      ...
      <!--  <div id="Left05">
          <div class="CenterContainer" style="background-color: #DDDDDD; position: relative; top: -30px;">
            <div id="AboutMeImage" style="margin-left: 20px; margin-top: 50px;">
            <h3 class="AboutSub" style="right: -300px;">ABOUT ME</h3>
            <p class="AboutSub" style="top: -10px;"> Hello my name is Ajay and I am a passionate coder who blah blah blah blah blah </br>
              I am an amazing coder and I build websites and stuff and I can code in over 12 different
              programming languages and I am very happy with my progress, I aspire to become even MORE
              fluent in machine learning algorithms </p>
        ...
        <div id="Right01" style="position: relative; top: 30px;">
          <h3 style="margin-left: 80px; font-size: 25px;"> RECOMMENDED POSTS </h3>
          <div style="" class="CenterContainer">
            ...
            <div style="background-color: #D1D3D4; "  style="grid-column: 4;" class="TutorialPost">
                <div class="HoverContainer">
                  <h4 style="margin-left: 20px;"> ABOUT </h4>
                  <p style="position: relative; top: -25px;"> This is the description of the tutorial that </br>
                    you are about to click on today </br> I hope you really
        ...
        <div id="Right02">
          <div class="CenterContainer" style="background-color: #e2e2e2;">
            <div id="ProjectHeader" style="background-color:#e2e2e2; position: relative; top: -35px;">
              <div class="CenterContainer" style="font-size: 20px;">DEVELOPMENT LOGS</div>
            </div>
          <!--   <div style="background-color:#D1D3D4;">
              <div class="ChildCenterContainer CenterContainer" style="background-color: #BCBEC0;"></div>
            </div>
            <div style="background-color:#D1D3D4;">
           <h4>PROJECT NAME</h4>
              <p style="margin-left: 10px; margin-right: 10px;"> Description of this project, well mainly this
                description should be about nefarious
                because this is the latest project that you should be
                working on but it's fine... This is just a simple placeholder
              description which will be replaced using PHP later, blah blah blah
              blahl blah boring stuff.. </p>
              <div class="LightGreenCallToAction">More?</div>
            </div>!-->
            <div style="background-color:#e2e2e2; height: 1950px; position: relative; top: -5px;">
                ...
                <div class="SimpleLog" style="height: 150px;">
                  ...
                  <p> This is a simple description of what
                    this post was about, sometimes this will
                    just be a log so have a little tag explaining, this needs to be
                    </p>
                </div>
                <div class="SimpleLog" style="height: 150px;">
                  <div style="width: 90%;"class="Seperator"></div>
            ...
            <div style="margin: auto; position: relative; top: 430px;">
              <div style=""class="LightGreenCallToAction">See More!</div>
            </div>
          </div>
        ...
        <!--<div id="Right03" style="grid-column: 2; grid-row-start: 5; grid-row-end: 6;">
          <h3 style="margin-left: 40px; font-size: 25px;"> COMING SOON </h3>
          <div style="" class="CenterContainer">

            <div style="background-color: #D1D3D4; " class="TutorialPost">
                  <h3 style="font-family:'Francois One', sans-serif; width: 100%; text-align: center;">COMING OUT <span style="color:#369B31"> 19/03/18 </span> </h3>
                <div class="HoverContainer">
                  <h4 style="margin-left: 20px;"> ABOUT </h4>
                  <p style="position: relative; top: -25px;"> This is the description of the tutorial that </br>
                    you are about to click on today </br> I hope you really
